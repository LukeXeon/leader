...
public class VisualizerView extends View {
    ...
    public VisualizerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        t.recycle();
        //
        mMinPoint = dip2px(context, 2);
        mhalfPoint = dip2px(context, 1);
        mBytes = null;
            ...
            if (!mLineIsSingleColor) {
                mPaint.setShader(new LinearGradient(
                        ...
                        new int[]{mFirstPartColor,
                                ...
                                mFourthPartColor,
                                mFourthPartColor},
                        new float[]{0f, 0.65f, 0.64f, 0.75f, 0.74f, 0.85f, 0.84f, 1f},
                        Shader.TileMode.CLAMP));

                canvas.drawLine(mPoints[i * 4], mPoints[i * 4 + 1],
                        mPoints[i * 4 + 2], mPoints[i * 4 + 3], mPaint);
            }
        }
        if (mLineIsSingleColor) {
