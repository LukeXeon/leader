...
public abstract class AbstractLrcView extends View {
     ...
     */
    public static final int LRCSTATUS_NOLRC_GOTOSEARCH = 2;
    /**
     * 无歌词-显示默认文本
     */
    public static final int LRCSTATUS_NOLRC_DEFTEXT = 3;
        ...
        synchronized (lock) {
            ...
            if (mLrcStatus == LRCSTATUS_INIT || mLrcStatus == LRCSTATUS_NOLRC_DEFTEXT) {
                ...
                LyricsUtils.drawDynamicText(canvas,
                        ...
                        hlWidth,
                        x, y);
            } else if (mLrcStatus == LRCSTATUS_LOADING
                    || mLrcStatus == LRCSTATUS_ERROR
