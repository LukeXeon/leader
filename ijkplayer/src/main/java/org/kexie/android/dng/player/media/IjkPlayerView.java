...
import org.kexie.android.dng.player.utils.AnimHelper;
...
import static org.kexie.android.dng.player.utils.StringUtils.generateTime;
...
public class IjkPlayerView extends FrameLayout
    ...
    private void _initView(Context context) {
        ...
        mFloatWindow = findViewById(R.id.float_window);
        // 视频宽高比设置
    ...
    private void _initMediaPlayer() {
        ...
        try {
            ...
            boolean autoBrightness = Settings.System.getInt(cr, Settings.System.SCREEN_BRIGHTNESS_MODE)
        ...
        switch (status) {
            ...
            case MediaPlayerParams.STATE_COMPLETED:
                ...
                if (mVideoView.getDuration() == -1 ||
                    ...
                    mInterruptPosition = Math.max(mVideoView.getInterruptPosition(), mInterruptPosition);
                    Toasty.error(mAttachActivity, "网络异常", Toast.LENGTH_SHORT).show();
                } else {
...
//        mVideoView.setOnCompletionListener(l);
    ...
    private void _initMediaQuality() {
        ...
        mFlMediaQuality.setVisibility(GONE);
    ...
    private void _initDanmaku() {
        ...
        int navigationBarHeight = NavBarUtils.getNavigationBarHeight(mAttachActivity);
    ...
    private void _recoverScreen() {
        ...
        if (mDanmakuColorOptions != null
                && mDanmakuColorOptions.getWidth() != 0) {
            _toggleMoreColorOptions();
        }
    }
