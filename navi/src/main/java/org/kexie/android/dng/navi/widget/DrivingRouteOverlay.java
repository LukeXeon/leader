...
public class DrivingRouteOverlay extends RouteOverlay
{
                               ...
                               LatLonPoint start, LatLonPoint end, List<LatLonPoint> throughPointList)
    {
        ...
        mAMap = amap;
        this.drivePath = path;
        startPoint = Point.box(start).unBox(LatLng.class);
        endPoint = Point.box(end).unBox(LatLng.class);
    ...
    private void colorWayUpdate(List<TMC> tmcSection)
    {
        ...
        mPolylineOptionscolor.add(Point.box(tmcSection.get(0).getPolyline().get(0)).unBox(LatLng.class));
        ...
        for (int i = 0; i < tmcSection.size(); i++)
        {
            ...
            {
                mPolylineOptionscolor.add(Point.box(mployline.get(j)).unBox(LatLng.class));
                colorList.add(color);
            }
        }
        colorList.add(getDriveColor());
