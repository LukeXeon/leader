...
public final class Tuple6<T1,T2,T3,T4,T5,T6> extends AbstractTuple implements Serializable
{
    private static final long serialVersionUID = 8222365942196155590L;
